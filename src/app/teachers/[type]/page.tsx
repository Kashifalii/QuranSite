  ...
  return (
    <>
      ...
      <section className="container-page py-20">
        ...
        {/* links */}
        <div className="flex items-center justify-center gap-3 z-10 mt-7 bg-amber-50 rounded-xl w-fit p-3 mx-auto">
          <Link
            href="/teachers/male"
            aria-label="Male Teachers"
            className={`focus-ring rounded-lg px-4 py-2 min-w-[120px] text-center text-sm font-bold bg-[var(--gold-soft)] text-[var(--emerald)]`}
          >
            Male
          </Link>
          <Link
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {list.map((teacher) => (
            ...
            >
              <div className=" relative mx-auto size-48 overflow-hidden rounded-full border-2 border-[var(--gold)] p-2">
                <Image
                  src={teacher.image}
                  alt={teacher.name}
                  fill
